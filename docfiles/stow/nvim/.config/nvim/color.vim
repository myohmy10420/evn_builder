...
set t_Co=256
set termguicolors " 更豐富的色彩


" hi 樣式名稱
" Vim       => guifg=字體   guibg=背景   gui=字型
" Terminal  => ctermfg=字體 ctermbg=背景 cterm=字型 (不知道哪裡會生效)
...
hi rubyFunction               ctermfg=12 guifg=#96D9F1
hi rubyGlobalVariable         ctermfg=12 guifg=#96D9F1
hi rubyHelper                 ctermfg=12 guifg=#96D9F1
hi rubyInstanceVariable       ctermfg=12 guifg=#96D9F1
hi rubyPseudoVariable         ctermfg=12 guifg=#96D9F1
...
hi link rubyMacro             Keyword
hi link rubyModule            Keyword
hi link rubySharpBang         Keyword
